...
const Logo = ({ className = "h-14 w-auto", ...props }) => {
  return (
    <svg 
    ...
    >
      ...
      <g transform="translate(0, 5)">
        ...
        {/* 4. Stylized Figure reaching up (Navy) */}
        <circle cx="282" cy="115" r="7" fill="#0F2B5B" />
        <path 
        ...
        {/* 6. Curved path ground (Light Gray) */}
        <path 
